    ...
    <BrowserRouter>
      <div className="min-h-screen bg-surface-0 relative">
        ...
        <div className="relative z-10">
          <header className="sticky top-0 z-50 glass border-b border-white/[0.04] animate-slide-down">
            <div className="max-w-[1100px] mx-auto px-4 sm:px-6">
              <div className="flex justify-between items-center h-14">
                <a href="/" className="flex items-center group">
                  <Logo size={30} variant="full" animated />
                </a>
                <div className="flex items-center gap-2">
                  <a
                    ...
                    className="w-9 h-9 rounded-lg bg-white/[0.03] border border-white/[0.06] flex items-center justify-center text-ash hover:text-white hover:bg-white/[0.08] hover:border-white/[0.12] hover:shadow-[0_0_20px_rgba(251,191,36,0.15)] transition-all duration-300 hover:scale-110"
                  >
          ...
          <footer className="border-t border-white/[0.04]">
            <div className="max-w-[1100px] mx-auto px-4 sm:px-6 py-5">
              <div className="flex flex-col sm:flex-row justify-between items-center gap-3">
                <Logo size={18} variant="icon" animated={false} />
