    ...
    <BrowserRouter>
      <div className="min-h-screen bg-[#0a0a0f] relative">
        ...
        <div className="relative z-10">
              ...
              <div className="flex justify-between items-center h-16">
                ...
                <div className="flex items-center space-x-3">
                  <a
                    ...
                    className="w-9 h-9 rounded-xl bg-white/[0.04] border border-white/[0.06] flex items-center justify-center text-surface-400 hover:text-white hover:bg-white/[0.08] hover:border-white/[0.1] transition-all"
                  >
          ...
          <footer className="border-t border-white/[0.06] bg-[#0a0a0f]/80 backdrop-blur-xl">
