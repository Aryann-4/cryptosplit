    ...
    <BrowserRouter>
      <div className="min-h-screen bg-surface-0 relative">
        ...
        <div className="fixed inset-0 pointer-events-none overflow-hidden">
          <div className="absolute -top-40 -left-40 w-[600px] h-[600px] bg-accent/[0.04] rounded-full blur-[150px]" />
          <div className="absolute -bottom-40 -right-40 w-[500px] h-[500px] bg-blue/[0.03] rounded-full blur-[120px]" />
        </div>
              ...
              <div className="flex justify-between items-center h-14">
                ...
                <div className="flex items-center gap-2">
                  <a
                    ...
                    className="w-9 h-9 rounded-lg bg-white/[0.03] border border-white/[0.06] flex items-center justify-center text-ash hover:text-white hover:bg-white/[0.06] transition-all"
                  >
